...
export const AllOrder = ({ dataOrder }: { dataOrder: OrderProps | undefined }) => {
    ...
    return (
        <div>
            <div className="grid grid-cols-7 text-sm bg-white p-6 items-center rounded-sm ">
                <p className="col-span-3 text-2xl font-medium">Danh sách đơn hàng</p>
