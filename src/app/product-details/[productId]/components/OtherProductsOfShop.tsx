...
export const OtherProductsOfShop = ({ sellerID }: { sellerID: string | undefined }) => {
    ...
    return (
        <div >
            ...
            <p className="font-medium text-2xl p-4 py-6 ">Các sản phẩm khác của Shop</p>
                            ...
                            <Card className="p-0 rounded-sm">
                                <CardContent className="p-0">
                                    <div className="relative p-1 rounded-sm shadow bg-white cursor-pointer" >
                                        ...
                                        <p className="line-clamp-2 text-sm text-[var(--color-text-root)]">{value.name}</p>
                                        ...
                                        <div className="mt-6">
                                            <div className="absolute bottom-1 ">
                                                <p className="text-[var(--color-text-root)] font-medium flex justify-center items-center text-sm">  {new Intl.NumberFormat("vi-VN", { style: "currency", currency: "VND" }).format((value.price / 100) * (100 - value.discount_percentage))} {value.discount_percentage > 0 && <FiTrendingDown className="text-red-400 ml-1" />}</p>
                                            </div>
