...
export default function ProductChoisePay({
  ...
  return (
    product &&
    infoSeller && (
      <div className="bg-white p-6 rounded-xl mt-2 mb-10">
        ...
        <div className="flex justify-between items-center border-t py-6 pr-16 mt-10">
          ...
          <Button className="bg-[var(--color-button)] hover:bg-[var(--color-hover-button)] text-white w-32 rounded-sm" onClick={handlePay}> 
            Đặt hàng
          </Button>
        </div>
      </div>
